...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/png" href="assets/images/kj-connect-logo.png"> 
	</head>
<body>
<main class="twt-main">
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="<?php echo BASE_URL . "assets/images/kj-connect-logo.png"; ?>" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">See what’s happening in the KJSCE right now</span>
                        <span class="join">Join KJConnect Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li style="color:#1DA1F2;"><b> WP2 Mini Project : Developed By Mihir Subramaniam(16010421115) and Smit Thakare(16010421116)</b></li>
                </ul>
            </footer>
        </main>
